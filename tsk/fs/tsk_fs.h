...
#define  TSK_FS_FILE_TAG 0x11212212
    ...
    */
    enum TSK_FS_TYPE_ENUM {
        ...
        TSK_FS_TYPE_QNX6 = 0x00100000,          ///< QNX6 file system
        TSK_FS_TYPE_QNX6_DETECT = 0x00100000,   ///< QNX6 auto detection
...
#define TSK_FS_TYPE_ISXFS(ftype) \
    ...
    * \ingroup fslib
    * Macro that takes a file system type and returns 1 if the type
    * is for a QNX6 file system. */
#define TSK_FS_TYPE_ISQNX6(ftype) \
    (((ftype) & TSK_FS_TYPE_QNX6_DETECT)?1:0)
